...
pub const kitty_graphics_set = kitty_graphics.set;
pub const kitty_graphics_image = kitty_graphics.image_get_handle;
pub const kitty_graphics_image_by_number = kitty_graphics.image_get_handle_by_number;
pub const kitty_graphics_image_set_number = kitty_graphics.image_set_number;
pub const kitty_graphics_image_iterator_new = kitty_graphics.image_iterator_new;
pub const kitty_graphics_image_iterator_free = kitty_graphics.image_iterator_free;
pub const kitty_graphics_image_next = kitty_graphics.image_iterator_next;
