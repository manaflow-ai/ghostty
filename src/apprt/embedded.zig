...
pub const Surface = struct {
    ...
    pub const Options = extern struct {
        ...
        /// Drop replies generated by parsing terminal output. Input encoded
        /// from keyboard, text, mouse, and paste events still reaches the
        /// manual IO callback.
        suppress_terminal_responses: bool = false,
    };
    ...
    pub fn suppressTerminalResponses(self: *const Surface) bool {
        return self.suppress_terminal_responses;
    }
    ...
    pub fn newSurfaceOptions(self: *const Surface, context: apprt.surface.NewSurfaceContext) apprt.Surface.Options {
        ...
        return .{
            ...
            .suppress_terminal_responses = self.suppress_terminal_responses,
        };
    }
