...
pub const Message = union(enum) {
    ...
    pub const ColorSchemeReport = struct {
        /// Force write the current color scheme
        force: bool,

        /// This report was generated by a configuration refresh and may be
        /// the stale same-theme notification queued around Mode 2031 enable.
        suppress_duplicate: bool = false,
    };
    color_scheme_report: ColorSchemeReport,
