...
bool ghostty_surface_select_viewport_cell(ghostty_surface_t, uint16_t, uint16_t);
...
bool ghostty_surface_jump_to_prompt_cell(ghostty_surface_t, int16_t, uint16_t*, uint16_t*);
