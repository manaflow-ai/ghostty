...
// Predict target grid geometry without mutating or notifying the surface.
GHOSTTY_API ghostty_surface_size_s ghostty_surface_size_for_pixels(ghostty_surface_t, uint32_t, uint32_t);
